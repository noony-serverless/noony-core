...
For JWKS-based validation (the preferred approach for Auth0, Google, Microsoft), see [06-oauth2.md](./06-oauth2.md) for a complete `Auth0TokenValidator` implementation.
...
- Auth0, Google OAuth, and Microsoft Azure AD: [06-oauth2.md](./06-oauth2.md)
- Full `configureWithJWT` / `configureWithAPIKey` signatures: [02-complete-guide.md](./02-complete-guide.md)
