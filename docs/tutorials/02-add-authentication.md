...
- Full configuration options for `GuardSecurityConfig`, `GuardCacheConfig`, and all static methods: [Route Guards Reference](../reference/auth/route-guards.md)
- Supporting multiple auth methods in one app: [Multi-Auth Examples](../reference/auth/multi-auth.md)
- Firebase token validation: [Firebase Auth](../reference/auth/firebase.md)
- OAuth 2.0 providers: [OAuth2 Auth](../reference/auth/oauth2.md)
