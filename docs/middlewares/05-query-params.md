...
**Don't validate query params before confirming required headers are present.** Headers are cheaper to check and must come first (see [canonical ordering](./07-integration-guide.md)).

## Related

- [How to Compose Middleware Pipelines](./07-integration-guide.md) — combining with headers and path params
