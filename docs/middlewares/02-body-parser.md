...
To validate the shape and content of `parsedBody`, add `BodyValidationMiddleware` immediately after. See [How to Validate Request Bodies with Zod](./03-body-validation.md).
