...
export class DemoDataGenerator {
  ...
  getDemoUsers(): DemoUser[] {
    // Return a basic set of predefined users for testing
    // In a real scenario, this would cache the result from generateDemoUsers()
    return [
      {
        userId: 'user-001',
        name: 'John Doe',
        ...
        demo: {
          ...
          expectedBehavior: {
            '/demo/plain/basic': 'allow',
            '/demo/plain/admin': 'deny',
          },
        },
      },
      {
        ...
        demo: {
          ...
          tokens: {
            ...
            refresh: 'mock-admin-refresh',
          },
          expectedBehavior: {
            '/demo/plain/basic': 'allow',
            '/demo/plain/admin': 'allow',
            '/demo/wildcard/users/*': 'allow',
          },
        },
      },
    ];
